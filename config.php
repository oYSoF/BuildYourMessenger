<?php
define('API_KEY_CR', '354654654:dslidjflskdflskdnlkdlkn');  //توکن ربات اصلی
define('API_KEY_LOCK_BOT', API_KEY_CR);
##----------------------
$host_folder = 'https://example.com/TGbots/BuildYourMessenger'; //ادرس فولدر سورس
$admin = 75632587; // ایدی عددی ادمین
$support = '@SupportBot'; // پشتیبانی
$main_channel = '@BuildYourMessenger'; // یوزرنیم کانال
$main_bot = '@BuildYourMessengerBot'; // یوزرنیم ربات
$logchannel = '-100185565469'; // ایدی عددی کانال برای ارسال لاگ
$public_logchannel = '@Publicchlg'; // ایدی کانال عمومی که ربات اصلی در ان ادمین است برای بخش تبلیغات

$lock_channel_1 = '@BuildYourMessenger'; // کانال اول قفل
$lock_channel_2 = '@BuildYourMessenger2'; // کانال دوم قفل
...
$vip_price = is_numeric($vip_price) ? $vip_price : 3000; // قیمت پیشفرض وی ای پی 3000 تومن
##----------------------اطلاعات دیتابیس
$DB_HOST = 'localhost';
$DB_NAME = 'buildfgdfg'; // نام دیتابیس
$DB_USERNAME = 'vxcvxcv';  //یوزرینم برای اتصال به دیتابیس
$DB_PASSWORD = 'ABCDSzcx5vgvbn41dsd'; // پسورد برای اتصال به دیتابیس
##----------------------##
